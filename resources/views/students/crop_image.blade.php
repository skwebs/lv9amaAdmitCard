...
<head>
  ...
  <!-- cropperjs  -->
	<script src="https://cdnjs.cloudflare.com/ajax/libs/cropperjs/1.5.12/cropper.min.js" integrity="sha512-ooSWpxJsiXe6t4+PPjCgYmVfr1NS5QXJACcR/FPpsdm6kqG1FmQ2SVyg2RXeVuCRBLr0lWHnWJP6Zs1Efvxzww==" crossorigin="anonymous" referrerpolicy="no-referrer"></script>  <style>
    .label {
      cursor: pointer;
    }
            ...
            $.ajax('{{route("student.save_image")}}', {
              ...
              success: function (res) {
                ...
                if(res.success){
	                ...
	                window.location.replace("{{ route('student.list')}}");
